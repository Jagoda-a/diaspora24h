// app/(seo)/danasnje-vesti/page.tsx
...
export async function generateMetadata(): Promise<Metadata> {
  const title = 'Današnje vesti | Diaspora24h'
  const description = 'Današnje vesti iz Srbije — pregled najvažnijih dešavanja danas na jednom mestu.'
  const canonical = '/danasnje-vesti'
  return {
    title,
    description,
...
export default async function Page() {
  ...
  since.setHours(0, 0, 0, 0) // od ponoći danas
  ...
  return (
    <div className="container" style={{ padding: 16 }}>
      ...
      <h1 style={{ margin: 0 }}>Današnje vesti</h1>
