...
export async function generateMetadata(): Promise<Metadata> {
  const title = 'Dijaspora vesti | Diaspora24h'
  const description = 'Vesti iz Srbije za našu dijasporu — pregled najvažnijih tema na jednom mestu.'
  const canonical = '/dijaspora-vesti'
  return {
...
export default async function Page() {
  ...
  const listJsonLd = {
    '@context':'https://schema.org','@type':'ItemList',name:'Dijaspora vesti',
